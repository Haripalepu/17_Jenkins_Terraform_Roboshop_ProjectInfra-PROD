...
module "vpn" {
    ...
    source = "git::https://github.com/hari-palepu/17_Terraform_SG_Modules.git?ref=main"
...
resource "aws_security_group_rule" "alb_payment" {
...
resource "aws_security_group_rule" "alb_catalogue" {
